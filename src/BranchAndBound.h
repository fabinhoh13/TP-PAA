#ifndef BRAANCHANDBOUND_H
#define BRAANCHANDBOUND_H
...
class BranchAndBound {
   ...
   public:
    BranchAndBound(int nitems, int weight);
    ~BranchAndBound();

    /**
     * For a given instance, solve the Knapsack Knapsack iteratively using a solution table.
     ...
     * @param instance is the instance data.
     */
    void initialSolution(const Knapsack* instance);
     ...
     * @return true if it is complete.
     */
    bool isConsistent(const Knapsack* instance, vector<int> items);

    /**
     * Check if the solution is promissing by predicting it.
     * @return true if it is complete.
     */
    bool isPromissing(const Knapsack* instance, vector<int> items, int idx, int value, int weight);

    /**
     * For a given instance, display the solution for the Knapsack Knapsack.
     * @param instance is the instance data.
     */
    void printSolution(const Knapsack* instance);

   private:
    void _solve(const Knapsack* instance, vector<int> items, int item, int value, int weight);
};
